<nav class="navbar p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
      <a class="navbar-brand brand-logo-mini" href=""><img src="{{asset('admin/assets')}}/images/e-logo.png" alt="logo" /></a>
    </div> 
    ...
    <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
      ...
      <ul class="navbar-nav w-100">
        <li class="nav-item w-100">
          <form action="{{url('search')}}" method="get" class="nav-link mt-2 mt-md-1 d-none d-lg-flex search">
            @csrf
            <input type="text" name="key" class="form-control" value="{{old('key')}}" placeholder="Search products">
